...
+-------------+----------------------------------------+
| bmi         | weight in kg/(height in :math:`m^2`)   |
+-------------+----------------------------------------+
...
This should be a factor datatype (not int) (we don't want to compute
stuff like *average zip code*)
...
.. math:: \text{arc} = \beta + \alpha \text{sin-ang} + \gamma \text{cosang}
...
Approach1: divide group into 3 groups, and solve system of linear
equations
...
.. math:: arc_i = \beta + \alpha \text{sin-ang}_i + \gamma \text{cos-ang}_i +\varepsilon_i
...
.. math:: childHeight = \alpha + \beta midparentHeight + \varepsilon
...
.. |image0| image:: ch1_files/figure-html/unnamed-chunk-7-1.png
.. |image1| image:: ch1_files/figure-html/unnamed-chunk-8-1.png
.. |image2| image:: ch1_files/figure-html/unnamed-chunk-8-2.png
.. |image3| image:: ch1_files/figure-html/unnamed-chunk-8-3.png
.. |image4| image:: ch1_files/figure-html/unnamed-chunk-12-1.png
