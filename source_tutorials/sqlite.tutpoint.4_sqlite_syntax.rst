#################################
SQLite syntax (a whirl-wind tour)
#################################
...
- howeva, there are some commands which are case sensitive 
- example: ``GLOB`` and ``glob`` have different meaning in SQLite statements
...
- double dash ``--`` 
- C-style with ``/* ... */`` (can span multiple lines)

****************************
SQLite Statements and Clause
****************************
